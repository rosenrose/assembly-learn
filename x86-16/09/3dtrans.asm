...
world_points DD POINTS_CNT*4 DUP(?)
...
.STARTUP
    ...
    TX world_points[0], local_points[0], m_world
    TX world_points[1], local_points[1], m_world
    TX world_points[2], local_points[2], m_world
    TX world_points[3], local_points[3], m_world
